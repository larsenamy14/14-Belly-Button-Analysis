  ...
  d3.json("https://2u-data-curriculum-team.s3.amazonaws.com/dataviz-classroom/v1.1/14-Interactive-Web-Visualizations/02-Homework/samples.json").then((data) => {
    ...
    var data = [
      ...
      },
      {
        ...
        marker: {
          colors: [
            'rgba(192, 112, 119, .5)', 'rgba(128, 0, 128, .5)',
            'rgba(242, 56, 105, .5)', 'rgba(253, 241, 188, .5)',
            'rgba(40, 67, 109, .5)', 'rgba(99, 255, 201, .5)',
            'rgba(255, 98, 98, .5)', 'rgba(250, 102, 7, .5)',
            'rgba(82, 24, 250, .5)', 'rgba(174, 195, 176, 0)' 
          ]
        },
